...
extern "C" {
	...
	const uint16_t * com_tinker_get_sandbox_depth(realsense_capture* instance) {
		return instance->get_sandbox_depth();
	}
	...
	void com_tinker_setup_processing_params(realsense_capture* instance) {
		instance->setup_processing_params();
	}
}